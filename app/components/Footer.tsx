          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-delance-charcoal flex items-center justify-center
                           hover:bg-[#1877F2] transition-all duration-300 group"
                aria-label="Follow us on Facebook"
              >
                <svg className="w-5 h-5 text-delance-silver group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
